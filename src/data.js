// Ancient India - Neolithic Sites Data
// All information extracted from user-provided sources for UPSC preparation
...
export const flashcards = [
  // Northwest India - Mehrgarh
  {
    id: 'neolithic-1',
    category: 'neolithic',
    subcategory: 'Northwest India',
    title: 'Mehrgarh - Overview',
    content: 'Mehrgarh has produced evidence of early Neolithic times, dating to 7000 BC. Wheat and Barley were cultivated and sheep, goat and cattle were domesticated. This culture preceded the Indus Civilisation. Sites: Mehrgarh, Rana Ghundai, Sarai Kala and Jalilpur (now situated in Pakistan).',
    period: '7000 BC',
    importance: 'high',
    location: 'Northwest India (Pakistan)',
    facts: [
      'Earliest evidence of plant and animal domestication in India',
      'Preceded the Indus Civilisation',
      'Now situated in Pakistan'
    ]
  },
  {
    id: 'neolithic-2',
    category: 'neolithic',
    subcategory: 'Northwest India',
    title: 'Mehrgarh - 1st Cultural Phase',
    content: '1st cultural phase (7000-5500 BC) of Mehergarh: Cultivated crops and domesticated animals, but did NOT use pottery. They cultivated six-row barley, emmer and einkorn wheat, jujube, ilanthai, and dates. They were semi-nomadic, pastoral groups, built their houses with mud and buried the dead. They used sea shells, limestone, turquoise, lapis lazuli, and sandstone ornaments.',
    period: '7000-5500 BC',
    importance: 'high',
    location: 'Mehrgarh, Pakistan',
    facts: [
      'NO pottery usage',
      'Crops: six-row barley, emmer/einkorn wheat, jujube, ilanthai, dates',
      'Animals: sheep, goat, cattle',
      'Semi-nomadic, pastoral groups',
      'Mud houses',
      'Buried the dead',
      'Ornaments: sea shells, limestone, turquoise, lapis lazuli, sandstone'
    ]
  },
  {
    id: 'neolithic-3',
    category: 'neolithic',
    subcategory: 'Northwest India',
    title: 'Mehrgarh - 2nd and 3rd Cultural Phases',
    content: '2nd cultural phase (5500-4800 BC) and 3rd phase (4800-3500 BC) of Mehrgarh: They practised long-distance trade (revealed by Lapis Lazuli, which is available only in Badakshan). Evidence for pottery during these periods. Terracotta figurines and glazed faience beads have been found.',
    period: '5500-3500 BC',
    importance: 'high',
    location: 'Mehrgarh, Pakistan',
    facts: [
      'Long-distance trade with Badakshan (Lapis Lazuli)',
      'Pottery evidence',
      'Terracotta figurines',
      'Glazed faience beads'
    ]
  },
  {
    id: 'neolithic-4',
    category: 'neolithic',
    subcategory: 'Northwest India',
    title: 'Early Dentistry in Neolithic Mehrgarh',
    content: 'From the Neolithic period, people began to eat ground grain and cooked food, which caused dental and other health problems. The earliest evidence for drilling human tooth (of a living person) has been found at Mehrgarh. It is seen as a prelude to dentistry.',
    period: 'Neolithic Period',
    importance: 'high',
    location: 'Mehrgarh, Pakistan',
    facts: [
      'Earliest evidence of drilling human tooth',
      'Prelude to dentistry',
      'Caused by eating ground grain and cooked food'
    ]
  },
  ...
  // Valley of Kashmir
  {
    id: 'neolithic-5',
    category: 'neolithic',
    subcategory: 'Valley of Kashmir',
    title: 'Burzahom - Overview',
    content: 'Burzahom, an important site of this culture, provides evidence for the Megalithic and Early Historic Periods. People lived in pit dwellings to escape the cold weather. The houses were oval in shape, wide at the bottom and narrow at the top.',
    period: 'Megalithic & Early Historic Periods',
    importance: 'high',
    location: 'Valley of Kashmir',
    facts: [
      'Pit dwellings for cold weather protection',
      'Oval houses: wide bottom, narrow top',
      'Megalithic and Early Historic evidence'
    ]
  },
  {
    id: 'neolithic-6',
    category: 'neolithic',
    subcategory: 'Valley of Kashmir',
    title: 'Burzahom - Tools and Artifacts',
    content: 'They used bone & stone tools. There was evidence of menhirs (standing stone) and the use of redware pottery and metal objects. They used copper arrowheads. The people practised agriculture and domesticated animals.',
    period: 'Neolithic Period',
    importance: 'high',
  ...
  },
  {
    ...
    category: 'neolithic',
    subcategory: 'Valley of Kashmir',
    title: 'Burzahom - Agriculture and Trade',
    content: 'Seeds of wheat, barley, common pea and lentil have been recovered from the excavations. The use of lentil suggests that they had contacts with Central Asia. They were contemporary to Harappa civilization and traded with them.',
    period: 'Neolithic Period',
    importance: 'high',
    location: 'Burzahom, Kashmir',
    facts: [
      'Crops: wheat, barley, common pea, lentil',
      'Lentil use suggests Central Asian contacts',
      'Contemporary to Harappa civilization',
      'Traded with Harappans'
    ]
  },
  {
    id: 'neolithic-8',
    category: 'neolithic',
    subcategory: 'Valley of Kashmir',
    title: 'Burzahom - Cultural Phases',
    content: 'Two phases of Neolithic culture have been identified. They are termed aceramic and ceramic phases. Aceramic phase did not have evidence of ceramics. The ceramic phase shows evidence of pottery.',
    period: 'Neolithic Period',
    importance: 'medium',
    location: 'Burzahom, Kashmir',
    facts: [
      'Two phases: aceramic and ceramic',
      'Aceramic: no pottery evidence',
      'Ceramic: pottery evidence'
    ]
  },
  {
    id: 'neolithic-9',
    category: 'neolithic',
    subcategory: 'Valley of Kashmir',
    title: 'Burzahom - Pottery and Ornaments',
    content: 'They also used black ware pottery, beads of agate and carnelian and painted pottery.',
    period: 'Neolithic Period',
    importance: 'medium',
    location: 'Burzahom, Kashmir',
    facts: [
  ...
  },
  {
    ...
    category: 'neolithic',
    subcategory: 'Valley of Kashmir',
    title: 'Burzahom - Burial Site',
    content: 'A burial site produced wild dog bone and antler horn. An engraving of a hunting scene is depicted on a stone with dog and sun.',
    period: 'Neolithic Period',
    importance: 'medium',
    location: 'Burzahom, Kashmir',
    facts: [
      'Wild dog bone found',
      'Antler horn found',
      'Hunting scene engraving on stone',
      'Depicts dog and sun'
    ]
  },
  ...
  // Ganges Valley and Central India
  {
    id: 'neolithic-11',
    category: 'neolithic',
    subcategory: 'Ganges Valley',
    title: 'Ganges Valley and Central India - Major Sites',
    content: 'Lehuradeva, Chopani Munda, Koldiwa and Mahagara in Uttar Pradesh; Chirand and Senuwar in Bihar are major sites. These sites also have evidence of pottery and plant and animal domestication. These sites are characterised by cord-marked pottery.',
    period: 'Neolithic Period',
    importance: 'high',
    location: 'Uttar Pradesh & Bihar',
    facts: [
      'UP sites: Lehuradeva, Chopani Munda, Koldiwa, Mahagara',
      'Bihar sites: Chirand, Senuwar',
      'Cord-marked pottery characteristic',
      'Pottery and domestication evidence'
    ]
  },
  {
    id: 'neolithic-12',
    category: 'neolithic',
    subcategory: 'Ganges Valley',
    title: 'Lehuradeva - Early Rice Cultivation',
    content: 'The site of Lehuradeva (Uttar Pradesh) has produced early evidence of rice cultivation dated to 6500 BC.',
    period: '6500 BC',
    importance: 'high',
    location: 'Lehuradeva, Uttar Pradesh',
    facts: [
      'Earliest rice cultivation evidence',
      'Dated to 6500 BC',
      'Important for agricultural history'
    ]
  },
  {
    id: 'neolithic-13',
    category: 'neolithic',
    subcategory: 'Ganges Valley',
    title: 'Ganges Valley - Crops and Agriculture',
    content: 'Evidence for the cultivation of hulled and six-rowed barley, several types of wheat, rice, pea, green gram, and gram/chicken pea, mustard, flax/linseed and jackfruit have been found.',
    period: 'Neolithic Period',
    importance: 'high',
    location: 'Ganges Valley',
    facts: [
      'Barley: hulled and six-rowed varieties',
      'Multiple wheat types',
      'Crops: rice, pea, green gram, gram/chicken pea',
      'Oil seeds: mustard, flax/linseed',
      'Fruit: jackfruit'
    ]
  },
  {
    ...
    category: 'neolithic',
    subcategory: 'Ganges Valley',
    title: 'Ganges Valley - Animal Remains',
    content: 'Sheep, goat and cattle bones have been found besides bones of wild animals.',
    period: 'Neolithic Period',
    importance: 'medium',
    location: 'Ganges Valley',
    facts: [
      'Domesticated: sheep, goat, cattle',
      'Wild animal bones also found',
  ...
  // East India
  {
    ...
    title: 'East India - Neolithic Sites',
    content: 'The Neolithic sites are found at many sites in Bihar and West Bengal. Birbhanpur, Chirand, Kuchai, Golbaisasan, and Sankarjang are important sites.',
    period: 'Neolithic Period',
    importance: 'medium',
    location: 'Bihar & West Bengal',
    facts: [
      'Sites in Bihar and West Bengal',
      'Major sites: Birbhanpur, Chirand, Kuchai, Golbaisasan, Sankarjang',
      'Part of eastern Neolithic culture'
    ]
  },
  ...
  // South India
  {
    ...
    title: 'South India - Overview',
    content: 'South India (Andhra Pradesh, Karnataka and the North-western part of Tamil Nadu): Tools used include stone axes and blades. Fire-baked earthen figurines are found suggesting cattle keeping.',
    period: 'Neolithic Period',
    importance: 'high',
    location: 'Andhra Pradesh, Karnataka, Tamil Nadu',
    facts: [
      'Stone axes and blades',
      'Fire-baked earthen figurines',
      'Evidence of cattle keeping'
    ]
  },
  {
    id: 'neolithic-17',
    category: 'neolithic',
    subcategory: 'South India',
    title: 'South India - Ash Mounds',
    content: 'These sites have ash mounds in the centre with settlements around them. Utnur and Palvoy in Andhra Pradesh and Kodekal, Kupgal and Budihal in Karnataka feature ash mound sites.',
    period: 'Neolithic Period',
    importance: 'high',
    location: 'Andhra Pradesh & Karnataka',
    facts: [
      'Ash mounds with settlements',
      'AP sites: Utnur, Palvoy',
      'Karnataka sites: Kodekal, Kupgal, Budihal',
      'Unique archaeological feature'
    ]
  },
  {
    id: 'neolithic-18',
    category: 'neolithic',
    subcategory: 'South India',
    title: 'South India - Geographic Features',
    content: 'These sites are found near the granite hills with water sources. These sites are found in the river valleys of Godavari, Krishna, Pennaru, Tungabhadra and Kaveri.',
    period: 'Neolithic Period',
    importance: 'high',
    location: 'South India',
    facts: [
      'Near granite hills with water sources',
      'River valleys: Godavari, Krishna, Pennaru, Tungabhadra, Kaveri',
      'Strategic location for water access'
    ]
  },
  {
    id: 'neolithic-19',
    category: 'neolithic',
    subcategory: 'South India',
    title: 'South India - Karnataka Sites',
    content: 'Major sites in Karnataka include: Sanganakallu, Tekkalakota, Brahmagiri, Maski, Piklihal, Watkal, Hemmige and Hallur.',
    period: 'Neolithic Period',
    importance: 'medium',
    location: 'Karnataka',
    facts: [
  ...
  },
  {
    ...
    category: 'neolithic',
    subcategory: 'South India',
    title: 'South India - Andhra Pradesh Sites',
    content: 'Major sites in Andhra Pradesh include: Nagarjunakonda, Ramapuram, and Veerapuram.',
    period: 'Neolithic Period',
    importance: 'medium',
  ...
  },
  {
    ...
    category: 'neolithic',
    subcategory: 'South India',
    title: 'South India - Tamil Nadu Sites',
    content: 'Major site in Tamil Nadu: Paiyyampalli.',
    period: 'Neolithic Period',
    importance: 'medium',
    location: 'Tamil Nadu',
    facts: [
  ...
  // North East India
  {
    id: 'neolithic-22',
    category: 'neolithic',
    subcategory: 'North East India',
    title: 'North East India - Overview',
    content: 'North East India (Assam and Garo Hills): The culture dates from 2500-1500 BC. Tools like shouldered axes and splayed celts were found at the sites in Assam, Meghalaya, Nagaland and Arunachal Pradesh.',
    period: '2500-1500 BC',
    importance: 'high',
    location: 'Assam, Meghalaya, Nagaland, Arunachal Pradesh',
    facts: [
      'Dating: 2500-1500 BC',
      'Shouldered axes',
      'Splayed celts',
      'Found across Northeast states'
    ]
  },
  {
    id: 'neolithic-23',
    category: 'neolithic',
    subcategory: 'North East India',
    title: 'North East India - Shifting Cultivation',
    content: 'Daojali Hading and Sarutaru are important sites bearing evidence of shifting cultivation. The cultivation of yams and taro, building stone and wooden memorials for the dead, and the presence of Austro-Asiatic languages are the marked features of this region.',
    period: '2500-1500 BC',
    importance: 'high',
    location: 'Assam and Garo Hills',
    facts: [
      'Sites: Daojali Hading, Sarutaru',
      'Shifting cultivation evidence',
      'Crops: yams, taro',
